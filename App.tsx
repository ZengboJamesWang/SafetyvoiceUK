      ...
      {isOpen && (
        <div className="md:hidden bg-slate-800 border-t border-slate-700">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <Link to="/" className="block px-3 py-2 rounded-md text-base font-medium hover:bg-slate-700 transition">Home</Link>
            <Link to="/submit" className="block px-3 py-2 rounded-md text-base font-medium hover:bg-slate-700 transition">Submit Experience</Link>
            <Link to="/published" className="block px-3 py-2 rounded-md text-base font-medium hover:bg-slate-700 transition">Published Stories</Link>
            <Link to="/about" className="block px-3 py-2 rounded-md text-base font-medium hover:bg-slate-700 transition">About</Link>
            {isAdmin && <Link to="/admin/dashboard" className="block px-3 py-2 rounded-md text-base font-medium text-amber-400 hover:bg-slate-700 transition">Admin Dashboard</Link>}
          </div>
        </div>
      )}
    </nav>
