    ...
    <div className="max-w-4xl mx-auto px-4 py-16">
      ...
      <div className="bg-amber-50 p-8 rounded-3xl border border-amber-200 mb-12 shadow-sm">
        ...
        <p className="text-sm text-amber-800 leading-relaxed font-medium">
          In accordance with <strong>UK HEI Research Data Management</strong> standards and <strong>UK GDPR</strong>, all raw and processed data submitted to this platform will be <strong>securely archived for a minimum of 10 years</strong>. This ensures data integrity, supports longitudinal analysis, and complies with institutional data governance requirements.
        </p>
      </div>
      ...
      <div className="space-y-12 text-slate-700 leading-relaxed">
        <section className="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm">
          ...
          <ul className="list-disc pl-6 space-y-3 font-normal text-sm">
            <li><strong>Right to Erasure:</strong> You may request the deletion of your raw record at any time by contacting the administrators with your unique submission ID.</li>
        ...
        <section>
          ...
          <p>
            Raw data is stored in a partitioned environment with strict access controls. Access is limited to the platform administrators and designated Lead Moderators. Following the minimum 10-year archival period, all raw digital records will be permanently purged in accordance with institutional data destruction protocols.
          </p>
        </section>
      </div>
    </div>
